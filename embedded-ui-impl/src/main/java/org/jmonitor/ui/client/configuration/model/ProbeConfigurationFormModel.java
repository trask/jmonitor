...
public class ProbeConfigurationFormModel extends FormModel {
    ...
    public abstract static class ProbeConfigurationProvider extends
            BeanModelProvider<ProbeConfiguration> {
    }

    private final ProbeConfigurationProvider configurationProvider =
            GWT.create(ProbeConfigurationProvider.class);

    public void setBean(ProbeConfiguration configuration) {
