...
public interface UiServiceAsync {
    ...
    void getFullConfiguration(String sessionId, AsyncCallback<FullConfiguration> callback);

    void updateFullConfiguration(String sessionId, FullConfiguration configuration,
