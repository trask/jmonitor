...
public class SessionServlet extends HttpServlet {
    ...
    private static final String PAUSE_TIME_PARAMETER_NAME = "pauseTime";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String pauseSecondsText = request.getParameter(PAUSE_TIME_PARAMETER_NAME);
        int pauseSeconds = 0;
        ...
        try {
            Thread.sleep(TimeUnit.SECONDS.toMillis(pauseSeconds));
        ...
        for (Enumeration<?> e = request.getParameterNames(); e.hasMoreElements();) {
            ...
            if (name.equals(PAUSE_TIME_PARAMETER_NAME)) {
                continue;
            }
