...
public class UiConfigurationTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testAdminPassword() {
        ...
        UiConfiguration updatedConfiguration = ConfigurationServiceImpl.getInstance()
                .getUiConfiguration();
