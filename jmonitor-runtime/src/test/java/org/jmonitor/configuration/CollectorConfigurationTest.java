...
public class CollectorConfigurationTest extends AbstractTransactionalJUnit4SpringContextTests {

    @Test
    public void testEmailPassword() {

        CollectorConfiguration configuration = ConfigurationServiceImpl.getInstance()
        ...
        CollectorConfigurationImpl mutableConfiguration = ConfigurationImplHelper
        ...
        CollectorConfiguration updatedConfiguration = ConfigurationServiceImpl.getInstance()
                .getCollectorConfiguration();
