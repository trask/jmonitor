...
public class UiEntryPoint implements EntryPoint {
        ...
        uiService.getFullConfiguration(UiEntryPoint.sessionId,
                new AsyncCallback<FullConfigurationImpl>() {
                    public void onSuccess(FullConfigurationImpl configuration) {
                        ...
                        configurationWidget = new ConfigurationWidget(configuration);
                        configurationWidget.registerUpdateCallback(new UpdateCallback() {
                            public void onUpdate() {
                                displayMainWidget();
                            }
                        });
                        configurationWidget.registerCancelCallback(
                                new ConfigurationWidget.CancelCallback() {
    ...
    private void displayChangePasswordWidget() {
        ...
        changePasswordWidget.registerChangePasswordCallback(
                new ChangePasswordWidget.ChangePasswordCallback() {
                    public void onChangePassword() {
                        displayMainWidget();
                    }
                });
