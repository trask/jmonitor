 ...
 * @since 1.0
 */
public class OperationSafeImpl implements Operation {
    ...
    private final ExecutionTraceSafeImpl executionTrace;

    // stack trace data constructed from captured stack trace samplings
    private final SampledCallTreeSafeImpl sampledCallTree;
    ...
    public OperationSafeImpl(ProbeExecution probeExecution) {
        ...
        startTime = new Date();
        executionTrace = new ExecutionTraceSafeImpl(probeExecution);
        sampledCallTree = new SampledCallTreeSafeImpl();
    ...
    public long getStartNanoTime() {
        return executionTrace.getStartNanoTime();
    }

    public long getEndNanoTime() {
        return executionTrace.getEndNanoTime();
    }

    public long getDurationInNanoseconds() {
        return executionTrace.getDurationInNanoseconds();
    }

    public boolean isCompleted() {
        return executionTrace.isCompleted();
    }
    ...
    public String getUsername() {
        ProbeExecution probeExecution = executionTrace.getRootElement().getProbeExecution();
    ...
    public ExecutionTraceSafeImpl getExecutionTrace() {
        return executionTrace;
    }

    public SampledCallTreeSafeImpl getSampledCallTree() {
        return sampledCallTree;
    }
    ...
    public boolean wasCompletedBy(long nanoTime) {
        return executionTrace.wasCompletedBy(nanoTime);
    }
    ...
    public void captureStackTrace() {
        ...
        if (thread != null) {
            ...
            sampledCallTree.captureStackTrace(thread);
        }
    }
    ...
    public Operation flush() {
        ...
        synchronized (lock) {
            ...
            return new FlushedOperation(executionTrace.flush());
        }
    }
    ...
    private class FlushedOperation implements Operation {
        ...
        private final ExecutionTrace flushedExecutionTrace;

        public FlushedOperation(ExecutionTrace flushedExecutionTrace) {
            this.flushedExecutionTrace = flushedExecutionTrace;
        }
        ...
        public ExecutionTrace getExecutionTrace() {
            return flushedExecutionTrace;
        }

        public SampledCallTree getSampledCallTree() {
            return sampledCallTree;
        }
