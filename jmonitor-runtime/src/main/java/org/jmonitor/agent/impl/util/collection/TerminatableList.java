...
public class TerminatableList<E> implements Iterable<E> {
    ...
    // TODO check later if this is still used externally
    ...
    public boolean add(E o) {
        return offer(new Node<E>(o, null, null));
    }
    ...
    public Iterator<E> iteratorOverLastX(int x) {
    ...
    private static class TerminalNode<E> extends Node<E> {
