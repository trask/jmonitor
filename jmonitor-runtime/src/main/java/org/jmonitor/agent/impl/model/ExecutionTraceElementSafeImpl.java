 ...
 * @since 1.0
 */
public final class ExecutionTraceElementSafeImpl implements ExecutionTraceElement, IndexedElement {
    ...
    public ExecutionTraceElementSafeImpl(ProbeExecution probeExecution,
            long operationStartNanoTime, long startNanoTime, int index, int parentIndex, 
            int level) {
    ...
    public String getDescription() {
        ...
        probeExecution.printDescription(out);
        out.flush();
