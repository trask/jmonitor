...
public class OperationPrinter {
    ...
    private final int maxTraceElements;

    public OperationPrinter(PrintWriter out, int maxTraceElements) {
        ...
        this.out = out;
        this.maxTraceElements = maxTraceElements;
    }

    public void collect(final Operation operation) {

        OperationPrinterHelper helper = new OperationPrinterHelper(operation, out);
        helper.logOperation(maxTraceElements);
        out.flush();
    }
