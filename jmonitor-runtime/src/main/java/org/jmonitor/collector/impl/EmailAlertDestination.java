...
public class EmailAlertDestination implements AlertDestination {
    ...
    private static final Logger logger = CollectorServiceLoggerFactory
            .getLogger(EmailAlertDestination.class);
    ...
    private static void sendOperation(String subject, Operation operation) {
        ...
        OperationPrinter operationPrinter = new OperationPrinter(
                new PrintWriter(stuckReportWriter), configuration.getMaxTraceEventsPerEmail());
    ...
    public static void sendMessage(String subject, String message) {
        ...
        boolean authenticate = username != null && username.length() != 0 && password != null
                && password.length() != 0;
