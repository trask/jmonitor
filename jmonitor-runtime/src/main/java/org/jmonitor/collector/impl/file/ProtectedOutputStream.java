 ...
 * @see org.jmonitor.collector.impl.file.AtomicLogger.LoggerCallback#doWithLogger(java.io.PrintWriter)
 * @since 1.0
 */
public class ProtectedOutputStream extends FilterOutputStream {
    ...
    @Override
    public void write(int b) throws IOException { // NOPMD short name "c" is appropriate here
        if (active) {
            super.write(b);
        } else {
