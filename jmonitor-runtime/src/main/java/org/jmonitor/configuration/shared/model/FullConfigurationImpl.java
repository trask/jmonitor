...
public class FullConfigurationImpl implements FullConfiguration, Serializable {
    ...
    private MetricConfigurationImpl metricConfiguration;
    ...
    public MetricConfigurationImpl getMetricConfiguration() {
        return metricConfiguration;
    }

    public void setMetricConfiguration(MetricConfigurationImpl metricConfiguration) {
