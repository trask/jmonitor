...
public class JdbcProbe {
    ...
    private static final Logger logger = ProbeExecutionManagerFactory.getManager().getProbeLogger(
            JdbcProbe.class);
    ...
    private static StatementInfoCache statementInfoCache = new StatementInfoCache();
    ...
    public Object connectionPrepareAdvice(ProceedingJoinPoint joinPoint, String sql)
        ...
        PreparedStatement preparedStatement = (PreparedStatement) ProbeExecutionManagerFactory
                .getManager().proceedAndRecordMetricData(joinPoint, JDBC_PREPARE_SUMMARY_KEY);
        statementInfoCache.getPreparedStatementInfo(preparedStatement).setSql(sql);
    ...
    @AfterReturning("isProbeEnabled() && inOperation() && preparedStatementSetXPointcut()"
    ...
    public void preparedStatementSetXAdvice(PreparedStatement preparedStatement,
        ...
        if (x instanceof InputStream || x instanceof Reader) {
            statementInfoCache.getPreparedStatementInfo(preparedStatement).setParameterValue(
    ...
    @AfterReturning("isProbeEnabled() && inOperation() && preparedStatementSetNullPointcut()"
    ...
    @AfterReturning("isProbeEnabled() && inOperation() && statementAddBatchPointcut()"
    ...
    public void statementAddBatchAdvice(Statement statement, String sql) {
        ...
        statementInfoCache.getStatementInfo(statement).addBatch(sql);
    }
    ...
    @AfterReturning("isProbeEnabled() && inOperation() && preparedStatementAddBatchPointcut()"
    ...
    public void preparedStatementAddBatchAdvice(PreparedStatement preparedStatement) {
        ...
        statementInfoCache.getPreparedStatementInfo(preparedStatement).addBatch();
    }
    ...
    @Around("isProbeEnabled() && statementExecutePointcut()"
    ...
    public Object statementExecuteAdvice(ProceedingJoinPoint joinPoint, final Statement statement,
        ...
        final StatementInfo info = statementInfoCache.getStatementInfo(statement);
        ...
        ProbeExecutionCreator probeExecution = new ProbeExecutionCreator() {
            public ProbeExecution createProbeExecution() {
                ProbeExecution probeExecution = new JdbcProbeExecution(sql);
    ...
    @Around("isProbeEnabled() && inOperation() && preparedStatementExecutePointcut()"
    ...
    public Object preparedStatementExecuteAdvice(ProceedingJoinPoint joinPoint,
        ...
        final PreparedStatementInfo info = statementInfoCache
                .getPreparedStatementInfo(preparedStatement);
        ...
        ProbeExecutionCreator probeExecution = new ProbeExecutionCreator() {
            public ProbeExecution createProbeExecution() {
                ProbeExecution probeExecution = new JdbcProbeExecution(info.getSql(),
                        info.getParametersCopy());
                info.setLastProbeExecution(probeExecution);
                return probeExecution;
            }
        };
    ...
    @Around("isProbeEnabled() && inOperation() && statementExecuteBatchPointcut()"
    ...
    public Object statementExecuteBatchAdvice(ProceedingJoinPoint joinPoint, Statement statement)
        ...
        ProbeExecutionCreator probeExecution = new ProbeExecutionCreator() {
            public ProbeExecution createProbeExecution() {
                ProbeExecution probeExecution = new JdbcProbeExecution(info.getBatchedSqlCopy());
                info.setLastProbeExecution(probeExecution);
                return probeExecution;
            }
        };
    ...
    @Around("isProbeEnabled() && inOperation() && preparedStatementExecuteBatchPointcut()"
        ...
        ProbeExecutionCreator probeExecution = new ProbeExecutionCreator() {
            public ProbeExecution createProbeExecution() {
                ...
                if (info.isUsingBatchedParameters()) {
                    ...
                    probeExecution = new JdbcProbeExecution(info.getSql(),
                            info.getBatchedParametersCopy(), true);
                } else {
    ...
    @Around("isProbeEnabled() && inOperation() && resultNextPointcut()"
            + " && !cflowbelow(resultNextPointcut()) && target(resultSet)")
    public boolean resultNextAdvice(ProceedingJoinPoint joinPoint, final ResultSet resultSet)
            throws Throwable {

        JdbcProbeExecution lastProbeExecution = (JdbcProbeExecution) statementInfoCache
                .getStatementInfo(resultSet.getStatement()).getLastProbeExecution();
        ...
        boolean currentRowValid = (Boolean) ProbeExecutionManagerFactory.getManager()
                .proceedAndRecordMetricData(joinPoint, JDBC_NEXT_SUMMARY_KEY);
    ...
    @AfterReturning("isProbeEnabled() && statementClearBatchPointcut()"
            + " && !cflowbelow(statementClearBatchPointcut()) && target(statement)")
    public void statementClearBatchAdvice(Statement statement) {

        StatementInfo statementInfo = statementInfoCache.getStatementInfo(statement);
        statementInfo.clearBatch();
        statementInfo.setLastProbeExecution(null);
    }
}
