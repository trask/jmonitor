 ...
 * @since 1.0
 */
public abstract class ServletProbeProperty {
    ...
    private static String getProperty(String propertyName) {
        return ProbeExecutionManagerFactory.getManager().getProbeConfiguration().getProperty(
                SERVLET_PROBE_NAME, propertyName);
    }
}
